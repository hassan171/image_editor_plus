...
class ImageEditor extends StatelessWidget {
  ...
  final o.ShapesOption? shapesOption;
  ...
  const ImageEditor({
    ...
    this.shapesOption = const o.ShapesOption(),
  });
          ...
          children: [
            GestureDetector(
              onScaleUpdate: (details) {
                ...
                var layer = layers.whereType<BackgroundLayerData>();
                if (layer.isNotEmpty) {
                  final backgroundLayer = layer.first;
                  if (backgroundLayer.locked) return;
                }
                ...
                if (details.pointerCount == 2) {
                  ...
                  scaleFactor = lastScaleFactor * details.scale;
                  setState(() {});
                }
              },
              onScaleEnd: (details) {
                  ...
                  if (widget.shapesOption != null)
                    BottomButton(
                      ...
                      onTap: () async {
                        ...
                        ShapeLayerData? shape = await showModalBottomSheet(
                          context: context,
                          backgroundColor: Colors.white,
                          builder: (BuildContext context) {
                            return const ImageEditorShapes();
                          },
                        );
              ...
              children: <Widget>[
                if (widget.reversible && currentRatio != null && currentRatio != 1)
                  IconButton(
                    ...
                    icon: Icon(
                      Icons.portrait,
                      color: isLandscape ? Colors.grey : Colors.black,
                    ),
                    onPressed: () {
                ...
                if (widget.reversible && currentRatio != null && currentRatio != 1)
                  IconButton(
                    ...
                    icon: Icon(
                      Icons.landscape,
                      color: isLandscape ? Colors.black : Colors.grey,
                    ),
                    onPressed: () {
                      currentRatio = 1 / currentRatio!;
                  ...
                  TextButton(
                    ...
                    child: Container(
                        ...
                        child: Text(
                          i18n(ratio.title),
                          style: TextStyle(
                            color: currentRatio == ratio.ratio ? Colors.black : Colors.grey,
                          ),
                        )),
                  )
              ],
                          ...
                          child: Container(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ColorPicker(
                                    wheelDiameter: (MediaQuery.of(context).size.width * 0.5).clamp(100.0, 500.0),
                                    color: currentColor,
